						...
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr height="30">
										...
										<td><?php if($vo["status"] == 2): ?><img class="tuangou" tuangou="<?php echo ($vo["id"]); ?>" src="__PUBLIC__/admin/img/yes.gif"/><?php else: ?><img class="tuangou" tuangou="<?php echo ($vo["id"]); ?>" src="__PUBLIC__/admin/img/no.gif"/><?php endif; ?></td>
