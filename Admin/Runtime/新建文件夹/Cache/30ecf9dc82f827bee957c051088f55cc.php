...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/listm" title="返回留言管理" class="tip-bottom"> 用户留言</a>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>用户留言列表</h5>
						</div>
						<!-- 组件内容区域 -->
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
										...
										<td><span title="<?php echo ($v["content"]); ?>"><?php echo substr($v['content'],0,90)?></span></td>
