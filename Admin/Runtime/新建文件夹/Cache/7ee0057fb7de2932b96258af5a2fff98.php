...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/show" title="返回首页案例" class="tip-bottom">首页案例</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/saveshow/id/<?php echo ($data["id"]); ?>/im/<?php echo ($_GET['im']); ?>"  method="post" enctype="multipart/form-data" class="form-horizontal">
								<?php if($_GET['im']== 1): ?><div class="control-group">
