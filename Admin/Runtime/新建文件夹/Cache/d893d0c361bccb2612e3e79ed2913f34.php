...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/menu" title="返回导航管理" class="tip-bottom"> 导航管理</a>
			<a href="#" class="current"> 导航列表</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>导航列表</h5><h5><a href="__URL__/addm">增加</a></h5>
						</div>
						<!-- 组件内容区域 -->
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<!-- 表格主体数据区域 -->
								<tbody>
								<?php if(is_array($data["menu"])): foreach($data["menu"] as $key=>$v): ?><tr>
										<td><?php echo ($v["id"]); ?></td>
										<td><?php echo ($v["title"]); ?></td>
										<td><?php echo ($v["path"]); ?></td>
										<td class="taskOptions">
									    	<a href="__URL__/updam/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="编辑"><i class="icon-pencil"></i></a>
									    	<a href="__URL__/delm/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="删除"><i class="icon-remove"></i></a>
									    	<a href="__URL__/bclass/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="查看下级分类"><i class="icon-share-alt"></i></a>
										</td>
