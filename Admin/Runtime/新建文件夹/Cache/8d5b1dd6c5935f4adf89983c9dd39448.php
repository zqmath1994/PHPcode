...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/casel" title="返回案例信息列表" class="tip-bottom"> 推荐案例管理</a>
						...
						<div class="widget-content nopadding">
							...
							<form action="__URL__/saveolay/id/<?php echo ($data["id"]); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div>
									...
									<div class="controls">
										<input style="margin-left:0px;"  type="radio" name="method" value="1" <?php if($data["method"] == 1): ?>checked<?php endif; ?>>文字
										<input style="margin-left:0px;" type="radio" name="method" value="2" <?php if($data["method"] == 2): ?>checked<?php endif; ?>>图片
									</div>
								</div>
								<div class="control-group">
