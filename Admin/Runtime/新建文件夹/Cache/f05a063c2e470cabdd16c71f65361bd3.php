...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__APP__/guide" title="返回引导页信息" class="tip-bottom">引导页信息</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/uguide"  method="post" class="form-horizontal">
								<div class="control-group">
									<label class="control-label">引导页信息：</label>
									<div class="controls"><textarea name="content" cols="30" rows="10"><?php echo ($data["content"]); ?></textarea></div>
								</div>
								<!-- 提交提交按钮 -->
