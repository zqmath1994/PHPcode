...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/lists" title="返回网站信息" class="tip-bottom"> 推荐案例管理</a>
			<a href="#" class="current"> 修改推荐案例</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/saveolay/id/<?php echo ($data["id"]); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div>
									...
									<div class="controls">
										<input type="radio" name="method" value="1" <?php if($data["method"] == 1): ?>checked<?php endif; ?>>文字
										<input type="radio" name="method" value="2" <?php if($data["method"] == 2): ?>checked<?php endif; ?>>图片
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">图片：</label>
									<div class="controls"><input type="file" name="image" /><br />
									<?php if(empty($$data["image"])): ?><img src="__PUBLIC__/images/<?php echo ($data["image"]); ?>" style="width:200px;height:100px;;margin-top:10px;"><?php endif; ?>
									</div>
								</div>
								<div class="control-group">
