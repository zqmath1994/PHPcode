        ...
        <div id="sidebar">
            ...
            <ul>
                <li class="submenu" id="home">
                    ...
                    <ul>
                        <li><a href="__APP__/Basis/guide">案例信息</a></li>
                        <li><a href="__APP__/Basis/slide">首页幻灯片</a></li>
                        <li><a href="__APP__/Basis/add">首页图片</a></li>
                        <li><a href="__APP__/Basis/add">首页案例标题</a></li>
                        <li><a href="__APP__/Basis/cop">版权信息</a></li>
                        <li><a href="__APP__/Basis/listm">留言信息</a></li>
                    </ul>
                </li>
              
                <li id="count"><a href=""><i class="icon icon-signal"></i> <span>网站管理</span></a></li>
...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__APP__/Basis" title="返回网站信息" class="tip-bottom">网站信息</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/ucop"  method="post" class="form-horizontal">
								<div class="control-group">
									<label class="control-label">引导页颜色：</label>
									<div class="controls"><input type="text" name='pcolor' value=""></div>
								</div>
								<div class="control-group">
									<label class="control-label">引导页字体：</label>
									<div class="controls"><input type="text" name="pfont" value=""></div>
								</div>
								<div class="control-group">
									<label class="control-label">引导页信息：</label>
									<div class="controls"><textarea name="content" cols="20" id="editor" rows="10" style="width:800px;height:200px;"><p><div><pre>xsaxas</pre></div></p></textarea></div>
								</div>
								<!-- 提交提交按钮 -->
