...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/sclass" title="返回子类列表" class="tip-bottom"> 子类管理</a>
			<a href="#" class="current"> 添加子类</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/inses" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div>
									...
									<div class="controls">
										...
										<?php if(is_array($data["bclass"])): foreach($data["bclass"] as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" selected><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
										</select>
									</div>
								</div>
								<!-- 提交提交按钮 -->
