...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/company" title="返回公司信息" class="tip-bottom"> 公司信息</a>
			<a href="#" class="current"> 公司信息列表</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>公司信息列表</h5><h5><a href="__URL__/addm">增加</a></h5>
						</div>
						<!-- 组件内容区域 -->
							...
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
										...
										<td class="taskOptions">
									    	<a href="__URL__/updac/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="编辑"><i class="icon-pencil"></i></a>
										</td>
