            ...
            <ul>
                <li class="submenu" id="home">
                    ...
                    <ul>
                        ...
                        <li><a href="__APP__/Basis/add">公司信息</a></li>
                    </ul>
                </li>
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/inseb" method="post" enctype="multipart/form-data" class="form-horizontal">
