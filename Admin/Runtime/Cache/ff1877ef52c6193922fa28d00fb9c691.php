...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__APP__/Web/casel" title="返回案例信息" class="tip-bottom">案例信息</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/savecase/id/<?php echo ($data["id"]); ?>"  method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls"><input type="text" name="lowertitle" value="<?php echo ($data["lowertitle"]); ?>"></div>
								</div>
								<div class="control-group">
									<label class="control-label">描述：</label>
									<div class="controls"><input type="text" name="outline" value="<?php echo ($data["outline"]); ?>"></div>
								</div>
								<div>
									<label class="control-label">幻灯片：</label>
									<div class="controls">
									<br><input type="file" name="pic1"><br><input type="text" name="title1"><input type="text" name="url1">
									<br><input type="file" name="pic2"><br><input type="text" name="title2"><input type="text" name="url2">
									<br><input type="file" name="pic3"><br><input type="text" name="title3"><input type="text" name="url3">
									<br><input type="file" name="pic4"><br><input type="text" name="title4"><input type="text" name="url4">
									<br><input type="file" name="pic5"><br><input type="text" name="title5"><input type="text" name="url5">
									<br><input type="file" name="pic6"><br><input type="text" name="title6"><input type="text" name="url6">
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="pid" id="">
										<?php if(is_array($sclass)): foreach($sclass as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($data['pid'] == $v['id']){echo 'selected';}?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
										</select>
									</div>
								</div>
																<div class="control-group">
									...
									<div class="controls">
										...
										<?php
 for($i=1;$i<=9;$i++){ echo "<option value='".$i."'>".$i."星</option>"; } ?>
										</select>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">内容：</label>
									<div class="controls"><textarea name="content" cols="20" id="editor" rows="10" style="width:800px;height:200px;"><?php echo ($data["content"]); ?></textarea></div>
								</div>
								<!-- 提交提交按钮 -->
