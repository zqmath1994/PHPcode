...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__APP__/casel" title="返回案例信息" class="tip-bottom">案例信息</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<!-- 编辑表单 -->
							<form action="__URL__/insecase"  method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls"><input type="text" name="lowertitle"></div>
								</div>
								<div class="control-group">
									<label class="control-label">描述：</label>
									<div class="controls"><input type="text" name="outline"></div>
								</div>
								<div>
 ...
 for($i=1;$i<=9;$i++){ echo "<option value='".$i."'>".$i."星</option>"; } ?>
								...
								<div class="control-group">
									...
									<div class="controls"><textarea name="content" cols="20" id="editor" rows="10" style="width:800px;height:200px;"></textarea></div>
								</div>
								<!-- 提交提交按钮 -->
