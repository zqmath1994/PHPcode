...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/bclass" title="返回基础信息" class="tip-bottom"> 分类管理</a>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>分类列表</h5><h5><a href="__URL__/addb">增加</a></h5>
						</div>
						<!-- 组件内容区域 -->
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
										...
										<td><img src="__PUBLIC__/images/<?php echo ($v["image"]); ?>"></td>
										<td class="taskOptions">
									    	<a href="__URL__/updab/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="编辑"><i class="icon-pencil"></i></a>
									    	<a href="__URL__/delb/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="删除"><i class="icon-remove"></i></a>
									    	<a href="__URL__/sclass/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="查看下级分类"><i class="icon-share-alt"></i></a>
										</td>
