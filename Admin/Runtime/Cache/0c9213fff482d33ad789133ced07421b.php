...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/slide" title="返回幻灯片信息" class="tip-bottom"> 首页幻灯片</a>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>幻灯片列表</h5><h5><a href="__URL__/add">添加</a></h5>
						</div>
						<!-- 组件内容区域 -->
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
										...
										<td width="600"><img src="__PUBLIC__/images/<?php echo ($v["image"]); ?>" width="600" height="180"></td>
										<td><?php echo ($v["url"]); ?></td>
										<td class="taskOptions">
											<a href="__URL__/uslide/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="编辑"><i class="icon-pencil"></i></a>
									    	<a href="__URL__/delsli/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="删除"><i class="icon-remove"></i></a>
										</td>
