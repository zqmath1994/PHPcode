...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/casel" title="返回案例管理" class="tip-bottom"> 案例馆里</a>
			<a href="#" class="current"> 推荐案例列表</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>推荐案例列表</h5><h5><a href="__URL__/addolay">增加</a></h5>
						</div>
						<!-- 组件内容区域 -->
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
										...
										<td><?php if($v["method"] == 1): ?>文字链接<?php else: ?>图片链接<?php endif; ?></td>
										<td><?php echo ($v["url"]); ?></td>
										<td class="taskOptions">
									    	<a href="__URL__/updaolay/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="编辑"><i class="icon-pencil"></i></a>
									    	<a href="__URL__/delolay/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="删除"><i class="icon-remove"></i></a>
										</td>
