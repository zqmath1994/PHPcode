...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/casel" title="返回案例信息" class="tip-bottom"> 案例信息</a>
			<a href="#" class="current"> 案例列表</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>案例列表</h5><h5><a href="__URL__/addcase">增加</a></h5>
						</div>
						<!-- 组件内容区域 -->
							...
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
										...
										<td class="taskOptions" style="width:100px;">
									    	<a href="__URL__/updacase/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="编辑"><i class="icon-pencil"></i></a>
									    	<a href="__URL__/delcase/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="删除"><i class="icon-remove"></i></a>
									    	<a href="__ROOT__/index.php/Company/index/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="查看页面"><i class="icon-search"></i></a>
										</td>
