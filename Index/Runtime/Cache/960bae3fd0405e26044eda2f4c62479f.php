...
<div class="wrap mb20" style="min-height:900px;">
	<div id="header" style="margin-top:-5px;">
		...
		<ul class="nav clearfix">
			<?php if(is_array($data["menu"])): foreach($data["menu"] as $key=>$v): ?><li class="m" onClick="dis_show()">
...
<div class="pbl_container">
  <div class="pblCon">
    <div class="demo clearfix">
      ...
      <?php if(is_array($datas["company"])): foreach($datas["company"] as $key=>$v): ?><div class="item masonry_brick">
          <div class="item_t">
            <div class="img"> <a href="__PUBLIC__/Uploads/<?php echo ($v["content"]); ?>" target="_blank"><img width="288" alt="<?php echo ($v["title"]); ?>" src="__PUBLIC__/Uploads/<?php echo ($v["pic"]); ?>" /></a>
            </div>
            <div class="title"><span><a href="__PUBLIC__/Uploads/<?php echo ($v["content"]); ?>" target="_blank"><?php echo ($v["title"]); ?></a></span></div>
          </div>
          <div class="item_b clearfix">
            <span><?php echo ($vo["objectname"]); ?></span>
...
<?php if($numb < 3): ?><div class="modal fixed_0" id="<?php echo ($vo["path"]); ?>">
	...
	<?php if(is_array($vo["bclass"])): foreach($vo["bclass"] as $key=>$v): $num = count($v['sclass']);?>
		<span class="tit<?php echo ($i); ?>" <?php if($num == 0): ?>style="margin-top:65px;text-align:center"<?php endif; if(($vo['id'] == 2) OR ($vo['id'] == 3)): ?>style="text-align:left;"<?php endif; ?>>
			...
			<?php if($i == 2): ?>style="margin-left:-20px;"<?php endif; ?>><?php echo ($v["title"]); ?></a></span><?php $i++; endforeach; endif; ?>
...
<div class="modal fixed_1" id="lianxi" style="font-family:'微软雅黑';">
    ...
    <div class="fixed_con3">
 	...
 	<?php if(is_array($data["config"]["email"])): foreach($data["config"]["email"] as $key=>$vo): ?><li class="fixed_con34" style="padding-top:15px"><?php echo ($vo); ?></li><?php endforeach; endif; ?>
       </ul>
       </div>
